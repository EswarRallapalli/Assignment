...
Then, create a class Researcher with an attribute field. Finally, create a class TeachingResearcher that inherits from both 
 Teacher and Researcher, and has an additional method to display both attributes.
...
class Researcher:
   def __init__(self,field):
      self.field=field
class TeachingReacher(Teacher,Researcher):
...
tr=TeachingReacher("Python","cumpas")
